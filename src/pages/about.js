...
import { FiUsers, FiBook, FiGlobe, FiTarget, FiAward, FiCheckCircle, FiTrendingUp, FiZap } from "react-icons/fi";
import {
  FaRocket, FaLightbulb, FaHandshake, FaChartLine,
  FaUserGraduate, FaCode, FaPaintBrush, FaCamera,
  FaVideo, FaMusic, FaPen, FaBriefcase, FaStar,
  FaCheckCircle
} from "react-icons/fa";
...
export default function About() {
  ...
  const stats = [
    { label: "Active Students", value: "10,000+", icon: <FaUserGraduate className="w-8 h-8" /> },
    { label: "Completed Projects", value: "5,000+", icon: <FaBriefcase className="w-8 h-8" /> },
    { label: "Client Satisfaction", value: "98%", icon: <FaStar className="w-8 h-8" /> },
    { label: "Universities", value: "500+", icon: <FiGlobe className="w-8 h-8" /> },
  ];
  ...
  const values = [
    {
      ...
      description: "We prioritize the growth and success of university students, providing them with real-world opportunities."
    },
    {
      icon: <FaBriefcase className="w-8 h-8" />,
      title: "Academic Excellence",
      description: "Our platform connects clients with students from top universities, ensuring high-quality work."
    },
    {
      icon: <FiGlobe className="w-8 h-8" />,
      title: "Global Reach",
      description: "We connect students and clients from around the world, fostering international collaboration."
    },
    {
      icon: <FiTarget className="w-8 h-8" />,
      title: "Innovation Focus",
      description: "We encourage innovative solutions and creative thinking in all projects."
    }
      ...
      >
        ...
        <section className="relative w-full py-20 overflow-hidden">
          ...
          <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            >
              UniFree is a next-generation freelancing platform built exclusively for university students. 
              We help talented students connect with potential clients, build real-world experience, and 
              earn money while they study.
            </motion.p>
          </div>
        </section>
          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            >
              ...
              <p className="mt-4 text-gray-600 dark:text-gray-300">
                We&apos;re on a mission to connect talented students with exciting opportunities. Whether you&apos;re looking to hire or be hired, we&apos;ve got you covered.
              </p>
            </motion.div>
          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center relative z-10">
            ...
            >
              ...
              <p className="mt-4 text-xl text-indigo-100">
                Whether you are a student looking for opportunities or a client seeking talent, we did love to have you on board.
              </p>
